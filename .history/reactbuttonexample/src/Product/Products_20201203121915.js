...
class Products extends Component {
  ...
  getBlogPost=()=>{
    axios.get('http://localhost:8080/api/stu')
    .then((response)=>{
  ...
  submit=(event)=>{
    ...
    emailjs.sendForm('gmail', 'template_xtdvvmo', event.target, 'user_kfoFlQEaUMCIoaj77nL60')
      .then((result) => {
  ...
  render(){
    ...
    return(<div className='app'>
      ...
      <form onSubmit={this.submit}>
        ...
        <h5 className="caution">*Once submitted, question can not be modified.</h5>
